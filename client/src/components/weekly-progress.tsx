...
export default function WeeklyProgress() {
 ...
 <h2 className="text-lg text-foreground">{t('weeklyProgress.title')}</h2>
 <p className="text-sm text-naya-cream0">{currentWeek} - {t('weeklyProgress.thisWeek')}</p>
 </div>
 ...
 <span className="text-sm text-naya-olive-70">{item.label}</span>
 <span className={`text-sm ${item.isCompleted ? 'text-secondary' : 'text-naya-olive-55'}`}>
