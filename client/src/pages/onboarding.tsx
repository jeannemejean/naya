...
function getLayerConfig(t: (key: string) => string) {
 return [
 { layer: 1, label: t('onboarding.layers.you'), steps: [2, 3], color: "bg-[rgba(158,126,135,0.12)]0" },
 { layer: 2, label: t('onboarding.layers.yourWork'), steps: [4, 5, 6, 7, 8, 9, 10], color: "bg-primary" },
 { layer: 3, label: t('onboarding.layers.everythingElse'), steps: [11, 12], color: "bg-naya-olive-060" },
 ];
}
...
function BoardGeneratingScreen() {
 ...
 <span className="text-2xl text-foreground">Naya</span>
 </div>
 <div className="space-y-2">
 <h2 className="text-xl text-foreground">{t('onboarding.boardGenerating.title')}</h2>
 <p className="text-sm text-naya-cream0">{t('onboarding.boardGenerating.subtitle')}</p>
 </div>
 ...
 <span className={`text-sm transition-colors duration-300 ${i <= activeStep ? 'text-foreground' : 'text-naya-olive-35'}`}>
 ...
 <p className="text-xs text-naya-olive-35">{t('onboarding.boardGenerating.complete', { percent: Math.round(progress) })}</p>
 </div>
 </CardContent>
 </Card>
 </div>
...
function SelectCard({ value, selected, onClick, icon, label }: {
 ...
 selected ? 'border-primary bg-primary/5 text-primary' : 'border-naya-olive-18 text-naya-olive-70 hover:border-naya-olive-18 '
 }`}
 >
...
function CheckCard({ selected, onClick, label }: { selected: boolean; onClick: () => void; label: string }) {
 ...
 >
 <div className={`w-4 h-4 rounded border flex-shrink-0 flex items-center justify-center ${selected ? 'border-primary bg-primary' : 'border-naya-olive-18 '}`}>
...
function FieldLabel({ children, optional }: { children: React.ReactNode; optional?: boolean }) {
 const { t } = useTranslation();
 return (
 <label className="block text-base text-foreground mb-2 mt-1">
 {children}
 {optional && <span className="ml-1.5 text-xs text-naya-olive-35 font-normal">{t('common.optional')}</span>}
 </label>
 );
}
...
function KeywordChipInput({
 ...
 className="hover:text-naya-mauve transition-colors leading-none"
 >
 ×
 </button>
 </span>
...
export default function Onboarding() {
 ...
 <span className="text-base text-foreground ">Naya</span>
 </div>
 {/* Layer indicator */}
 ...
 <h2 className="text-2xl text-foreground ">{t('onboarding.welcome.greeting')}</h2>
 <div className="max-w-md mx-auto space-y-4 text-sm text-naya-olive-55 leading-relaxed">
 <p>{t('onboarding.welcome.intro1')}</p>
 <p>{t('onboarding.welcome.intro2')}</p>
 <p className="font-medium text-naya-olive-70 ">{t('onboarding.welcome.intro3')}</p>
 </div>
 ...
 <div>
 <h2 className="text-2xl text-foreground ">{t('onboarding.howYouWork')}</h2>
 <p className="text-sm text-naya-cream0 mt-1">
 ...
 <p className="text-xs text-naya-olive-35 mb-2">{t('onboarding.selectAllThatApply')}</p>
 <div className="grid grid-cols-1 gap-2">
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-2xl text-foreground ">{t('onboarding.mainWorkTitle')}</h2>
 <p className="text-sm text-naya-cream0 mt-1">
 ...
 autoFocus
 />
 {!primary.name.trim() && <p className="text-xs text-naya-olive-35 mt-1">{t('onboarding.onlyRequiredField')}</p>}
 </div>

 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
 <div>
 <FieldLabel optional>{t('onboarding.website')}</FieldLabel>
 <Input placeholder={t('onboarding.websitePlaceholder')} value={primary.website} onChange={e => setPri('website', e.target.value)} className=" " />
 </div>
 <div>
 <FieldLabel optional>{t('onboarding.linkedin')}</FieldLabel>
 <Input placeholder={t('onboarding.linkedinPlaceholder')} value={primary.linkedinProfile} onChange={e => setPri('linkedinProfile', e.target.value)} className=" " />
 </div>
 <div>
 <FieldLabel optional>{t('onboarding.instagram')}</FieldLabel>
 <Input placeholder={t('onboarding.instagramPlaceholder')} value={primary.instagramHandle} onChange={e => setPri('instagramHandle', e.target.value)} className=" " />
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-2xl text-foreground ">{t('onboarding.step5Title')}</h2>
 <p className="text-sm text-naya-cream0 mt-1">
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.chooseWorkType')} /></SelectTrigger>
 <SelectContent>
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.chooseModel')} /></SelectTrigger>
 <SelectContent>
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.chooseSituation')} /></SelectTrigger>
 <SelectContent>
 ...
 {/* Optional first goal */}
 <div className="border border-naya-olive-18 rounded-lg p-4 space-y-3">
 <div>
 <p className="text-sm text-foreground ">{t('onboarding.achieveQuestion')}</p>
 <p className="text-xs text-naya-olive-35 mt-0.5">{t('onboarding.achieveOptional')}</p>
 </div>
 <div>
 ...
 <Input placeholder={t('onboarding.timeframePlaceholderAlt')} value={primary.initialGoalTimeframe} onChange={e => setPri('initialGoalTimeframe', e.target.value)} className=" " />
 </div>
 <div>
 <FieldLabel optional>{t('onboarding.goalTarget')}</FieldLabel>
 <Input placeholder={t('onboarding.targetPlaceholderAlt')} value={primary.initialGoalTarget} onChange={e => setPri('initialGoalTarget', e.target.value)} className=" " />
 </div>
 </div>
 )}
 </div>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-2xl text-foreground ">{t('onboarding.step6Title')}</h2>
 <p className="text-sm text-naya-cream0 mt-1">
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.chooseAudience')} /></SelectTrigger>
 <SelectContent>
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.chooseCoreChallenge')} /></SelectTrigger>
 <SelectContent>
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.chooseAspiration')} /></SelectTrigger>
 <SelectContent>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-2xl text-foreground ">{t('onboarding.step7Title')}</h2>
 <p className="text-sm text-naya-cream0 mt-1">
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.chooseStylePlaceholder')} /></SelectTrigger>
 <SelectContent>
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.choosePlatformPlaceholder')} /></SelectTrigger>
 <SelectContent>
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.choosePresencePlaceholder')} /></SelectTrigger>
 <SelectContent>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-2xl text-foreground ">{t('onboarding.step8Title')}</h2>
 <p className="text-sm text-naya-cream0 mt-1">
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.choosePriceRange')} /></SelectTrigger>
 <SelectContent>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-2xl text-foreground ">{t('onboarding.step9Title')}</h2>
 <p className="text-sm text-naya-cream0 mt-1">
 ...
 <p className="text-xs text-naya-olive-35 mb-2">{t('onboarding.brandVoiceHint')}</p>
 <KeywordChipInput
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-2xl text-foreground ">{t('onboarding.step10Title')}</h2>
 <p className="text-sm text-naya-cream0 mt-1">
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.chooseSuccessDefinition')} /></SelectTrigger>
 <SelectContent>
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.chooseBandwidth')} /></SelectTrigger>
 <SelectContent>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-2xl text-foreground ">{t('onboarding.step11Title')}</h2>
 <p className="text-sm text-naya-cream0 mt-1">
 ...
 <div key={p.id} className="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-naya-olive-18 bg-naya-olive-06 ">
 ...
 {p.intent && <span className="text-[10px] text-naya-olive-35 ">{INTENT_OPTIONS.find(o => o.value === p.intent)?.label}</span>}
 </div>
 </div>
 <button onClick={() => removeAdditionalProject(p.id)} className="text-naya-olive-18 hover:text-naya-mauve :text-naya-mauve flex-shrink-0 transition-colors">
 <X className="h-4 w-4" />
 </button>
 </div>
 ))}
 ...
 {addingProject ? (
 <div className="border border-primary/30 rounded-lg p-4 space-y-3 bg-primary/3">
 <div>
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.projectTypePlaceholder')} /></SelectTrigger>
 <SelectContent>
 ...
 <SelectTrigger className=" "><SelectValue placeholder={t('onboarding.intentPlaceholder')} /></SelectTrigger>
 <SelectContent>
 ...
 className="flex items-center gap-1.5 text-xs text-naya-cream0 hover:text-primary transition-colors"
 >
 ...
 <div>
 <FieldLabel optional>{t('onboarding.goalTitle')}</FieldLabel>
 <Input placeholder={t('onboarding.goalQuestionPlaceholder')} value={newProject.goalTitle} onChange={e => setNewProject(p => ({ ...p, goalTitle: e.target.value }))} className=" " />
 </div>
 <div>
 <FieldLabel optional>{t('onboarding.goalTimeframe')}</FieldLabel>
 <Input placeholder={t('onboarding.timeframePlaceholderShort')} value={newProject.goalTimeframe} onChange={e => setNewProject(p => ({ ...p, goalTimeframe: e.target.value }))} className=" " />
 </div>
 </div>
 )}
 ...
 className="w-full flex items-center gap-2 px-4 py-3 rounded-lg border-2 border-dashed border-naya-olive-18 text-naya-cream0 hover:border-primary hover:text-primary transition-colors text-sm"
 >
 ...
 <p className="text-xs text-naya-olive-35 text-center">
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-2xl text-foreground ">{t('onboarding.step12Title')}</h2>
 <p className="text-sm text-naya-cream0 mt-1">
 ...
 <div className="rounded-lg border border-[rgba(158,126,135,0.35)] bg-[rgba(158,126,135,0.12)] p-4">
 <p className="text-xs text-[#5c3d45] uppercase tracking-wider mb-2">{t('onboarding.howYouWorkSummary')}</p>
 <div className="flex flex-wrap gap-1.5">
 {opProfile.energyRhythm && <Badge variant="outline" className="text-xs border-[rgba(158,126,135,0.45)] text-[#5c3d45]">{opProfile.energyRhythm.replace(/-/g, ' ')}</Badge>}
 {opProfile.planningStyle && <Badge variant="outline" className="text-xs border-[rgba(158,126,135,0.45)] text-[#5c3d45]">{opProfile.planningStyle.replace(/-/g, ' ')} {t('onboarding.plannerSuffix')}</Badge>}
 {opProfile.activationStyle && <Badge variant="outline" className="text-xs border-[rgba(158,126,135,0.45)] text-[#5c3d45]">{opProfile.activationStyle.replace(/-/g, ' ')}</Badge>}
 {opProfile.avoidanceTriggers.length > 0 && <Badge variant="outline" className="text-xs border-[rgba(158,126,135,0.45)] text-[#5c3d45]">{t('onboarding.avoidancePatternsNoted', { count: opProfile.avoidanceTriggers.length })}</Badge>}
 </div>
 </div>
 )}
 ...
 {primary.businessType && <p className="text-xs text-naya-cream0 mt-0.5">{primary.businessType.replace(/-/g, ' ')}</p>}
 {primary.initialGoalTitle && (
 ...
 {/* Additional projects */}
 {additionalProjects.length > 0 && (
 <div className="rounded-lg border border-naya-olive-18 bg-naya-olive-06 p-4">
 <p className="text-xs text-naya-olive uppercase tracking-wider mb-2">{t('onboarding.additionalProjectsSummary')}</p>
 <div className="space-y-1.5">
 {additionalProjects.map(p => (
 <div key={p.id} className="flex items-center gap-2">
 <span className="text-sm">{TYPE_ICON[p.type] || '◇'}</span>
 <span className="text-sm text-naya-olive-70 ">{p.name}</span>
 {p.type && <Badge variant="outline" className="text-[10px] h-4 px-1.5 border-naya-olive-18 text-naya-olive ">{p.type}</Badge>}
 </div>
 ))}
 </div>
 </div>
 ...
 {step > 1 && (
 <Button type="button" variant="outline" onClick={back} className="flex items-center gap-1.5 ">
 ...
 {/* Skip Layer 1 button */}
 {(step === 2 || step === 3) && (
 <button onClick={skipToLayer2} className="text-xs text-naya-olive-35 hover:text-primary transition-colors ml-1">
 ...
 {/* Skip Layer 2 button */}
 {step >= 6 && step <= 10 && (
 <button onClick={skipToLayer3} className="text-xs text-naya-olive-35 hover:text-primary transition-colors">
 ...
 {step > 1 && (
 <p className="text-center text-xs text-naya-olive-35 mt-4">
